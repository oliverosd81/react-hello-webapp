          ...
          <div className="card mb-0" key={item.id} style={{ width: "auto", margin: "0 30px" }}>
            <div className="row align-items-center">
              ...
              <div className="col-md-2">
                <button type="button" className="btn btn-secondary" onClick={() => handleEditContact(item)}>Edit</button>
                <button type="button" className="btn btn-danger" onClick={() => handleDeleteContact(item.id)}>Delete</button>
              </div>
            </div>
          </div>
        ))}
